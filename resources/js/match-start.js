...
MatchGame.generateCardValues = function () {
  /* generate a sequential array of values 1 to 8 each value twice */
  ...
  while (sequentialValues.length > 0){
    ...
    var randomValue = sequentialValues.splice(randomIndex, 1)[0]; /* the splice method removes
     items and returns an array so we need to use [0]to access the first item in the array (even though
   this array will only have one number in it) */
